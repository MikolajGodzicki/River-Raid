...
namespace River_Raid.Core {
    public class ExplodeableGameObject : GameObject {
        ...
        public void Update(GameTime gameTime, int FrameCountX = 4, int ExplosionFrameCountX = 4) {
            if (IsExploding) {
                ...
                ExplodeAnimation = new Rectangle(
                    ExplodeTexture.Width / ExplosionFrameCountX * ExplosionAnimationFrame,
                    0,
                    ExplodeTexture.Width / ExplosionFrameCountX,
        ...
        public void Explode(SpriteBatch spriteBatch, Vector2 OffsetPosition = new Vector2(), float scale = 1f) {
            spriteBatch.Draw(ExplodeTexture,
